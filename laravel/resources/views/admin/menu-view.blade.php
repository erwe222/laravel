...
easyloader.load('datagrid', function(){ // 加载指定模块 
    $("#orderinfo").datagrid({
        ...
        columns: [[//表头标题栏
            {field: 'id', title: '订单ID号', width: 10, halign: 'center',height:30,checkbox:true},
            {field: 'order_pre_no', title: '旧订单号', align: 'center',width: 20,sortable:true},
            {field: 'logistics_name', title: '快递公司', align: 'center',width: 20,sortable:true},
