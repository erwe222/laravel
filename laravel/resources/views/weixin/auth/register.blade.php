            ...
            <div class="login-box">					
                <form action="javascript:;">
                  ...
                  <div class="login-form">		
                    ...
                    <div style="width:90px;background:red;float:right;text-align: center;line-height:30px;border-radius:15px;color:#ccc;background: #FFA366;padding-left: 5px;padding-right:5px;margin-top:-5px;">发送短信(20s)</div>
                  </div>
