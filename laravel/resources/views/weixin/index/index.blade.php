...
<head>
	...
	<meta charset="UTF-8">
	<title>小卖铺</title>
	<link rel="stylesheet" type="text/css" href="/weixin/themes/css/core.css">
	<link rel="stylesheet" type="text/css" href="/weixin/themes/css/icon.css">
	<link rel="stylesheet" type="text/css" href="/weixin/themes/css/home.css">
...
<body>
	...
	<div class="aui-content-box">
		<div class="aui-banner-content " data-aui-slider>
			<div class="aui-banner-wrapper">
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/weixin/themes/img/banner/news-banner2.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/weixin/themes/img/banner/news-banner1.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/weixin/themes/img/banner/news-banner3.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
		...
		<div class="aui-avd-content clearfix">
			<a href="#">
				<img src="/weixin/themes/img/pd/cf-1.jpg" alt="">
			</a>
			<a href="#">
				<img src="/weixin/themes/img/pd/cf-3.jpg" alt="">
			</a>
		</div>
		<div class="aui-title-head">
			<img src="/weixin/themes/img/icon/i-i1.png"  alt="">
		</div>
			...
			<div class="aui-slide-list">
				<ul class="aui-slide-item-list">
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-6.jpg">
						</a>
					</li>
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-5.jpg">
						</a>
					</li>
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-4.jpg">
						</a>
					</li>
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-3.jpg">
						</a>
					</li>
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-2.jpg">
						</a>
					</li>
					<li class="aui-slide-item-item">
						<a href="#" class="v-link">
							<img class="v-img" src="/weixin/themes/img/ad/tou-1.jpg">
						</a>
					</li>
				</ul>
			</div>
		...
		<div class="aui-title-head">
			<img src="/weixin/themes/img/icon/i-i2.png"  alt="">
		</div>
		<div class="aui-list-content">
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/weixin/themes/img/pd/cf-4.jpg" alt="">
				</div>
						...
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/pd-zf-6.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/pd-zf-7.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/pd-zf-8.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/pd-zf-9.jpg">
			...
			<div class="aui-title-head">
				<img src="/weixin/themes/img/icon/i-i3.png"  alt="">
			</div>
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/weixin/themes/img/pd/cf-5.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-31.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-32.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-17.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="#" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-18.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-19.jpg">
			...
			<div class="aui-title-head">
				<img src="/weixin/themes/img/icon/i-i4.png"  alt="">
			</div>
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/weixin/themes/img/pd/cf-7.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-25.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-26.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-27.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-28.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">唯他可可 椰子水饮料 330毫升/盒 12盒</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥189</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥299</span>
									</p>
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-29.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">巴黎水 含气青柠味饮料 330毫升 24</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥129</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥199</span>
									</p>
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-30.jpg">
									<p class="aui-slide-item-title aui-slide-item-f-els">calbee 卡乐比 日本进口休闲零食佳可比黄油味薯条 90克/盒</p>
									<p class="aui-slide-item-info">
										<span class="aui-slide-item-price">¥19.9</span>&nbsp;&nbsp;<span class="aui-slide-item-mrk">¥49</span>
									</p>
			...
			<div class="aui-title-head">
				<img src="/weixin/themes/img/icon/i-i5.png"  alt="">
			</div>
			<div class="aui-list-item">
				<div class="aui-list-item-img">
					<img src="/weixin/themes/img/pd/cf-8.jpg" alt="">
				</div>
				<div class="aui-slide-box">
					<div class="aui-slide-list">
						<ul class="aui-slide-item-list">
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-20.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-21.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-22.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-23.jpg">
							...
							<li class="aui-slide-item-item">
								<a href="ui-product.html" class="v-link">
									<img class="v-img" src="/weixin/themes/img/pd/sf-24.jpg">
		...
		<div class="aui-recommend">
			<img src="/weixin/themes/img/bg/icon-tj1.jpg" alt="">
			<!--<h2>为你推荐</h2>-->
		</div>
			...
			<div class="aui-list-product-box">
				<a href="ui-product.html" class="aui-list-product-item">
					<div class="aui-list-product-item-img">
						<img src="/weixin/themes/img/pd/sf-15.jpg" alt="">
					</div>
				...
				<a href="ui-product.html" class="aui-list-product-item">
					<div class="aui-list-product-item-img">
						<img src="/weixin/themes/img/pd/sf-14.jpg" alt="">
					</div>
					<div class="aui-list-product-item-text">
						<h3>KOBE LETTUCE 秋冬新款 女士日系甜美纯色半高领宽松套头毛衣针织衫</h3>
						<div class="aui-list-product-mes-box">
	...
	<footer class="aui-footer-default aui-footer-fixed">
		...
		<a href="{{route('w_user_main')}}" class="aui-footer-item">
